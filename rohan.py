...
def save_image_to_database(file_path):
  ...
  cursor.execute(
      ...
      (file_path,
       ))  # create user_id, and user table in database to store these infos.
...
home_btn = Button(container,
                  ...
                  command=whenHomeClicked)
home_btn.image = homeImg
home_btn.pack(pady=(280, 0))

purchase_btn = Button(container,
                      text="Purchase",
                      image=dollarImg,
                      compound="left",
                      height=35,
...
#function to change store name
def change_store_name(new_name):
...
def change_phone_number(new_number):
  store_name.config(text=new_number)
  
# log out button
logout_btn = Button(profile_card,
                    text="Log Out",
                    image=logoutImg,
                    compound="left",
                    height=35,
...
# change name button
change_name_btn = Button(profile_frame,
                         text="Change Name",
                         image=changeNameImg,
                         compound="left",
                         height=35,
